...
import { fetchNews, newsApproved } from "../../../features/news/newsSlice"
...
function ApprovedNews() {
  const newses = useSelector((state) => state.news.approved)

  const dispatch = useDispatch()

  const handleApprovedNews = (id) => {
              ...
              <div className={styles.news_item}>
                ...
                <div className={styles.news_actions}>
                  <div className={styles.add_btn}>
                    <button onClick={(e) => handleApprovedNews(news._id)}>
                      Approved
                    </button>
                  </div>
                </div>
